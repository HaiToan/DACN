...
// @route   POST /api/menu
// @access  Admin
router.post('/', verifyToken, adminOnly, createMenuItem); // Updated middleware usage

// @desc    Xóa một món ăn
// @route   DELETE /api/menu/:id
// @access  Admin
router.delete('/:id', verifyToken, adminOnly, deleteMenuItem); // Updated middleware usage

// @desc    Cập nhật một món ăn
// @route   PUT /api/menu/:id
// @access  Admin
router.put('/:id', verifyToken, adminOnly, updateMenuItem); // Updated middleware usage
